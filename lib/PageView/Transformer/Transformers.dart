...
class ThreeDTransform extends PageTransformer{
  @override
  Widget transform(Widget child, TransformInfo info) {
    // TODO: implement transform
    double positon=info.position;
    double height_=info.height;
    double width_=info.width;
    double privotx=0.0;
    ...
    return new Transform(
      ...
      ..rotate(new Vector3(0.0, 2.0, 0.0), positon * 1.5),
    origin: new Offset(privotx, height_ / 2),
    child: child,
    );
  }
  ...
  Widget transform(Widget child, TransformInfo info) {
    ...
    if(position > 0 && position<=1){
      return new Transform.translate(
          offset: new Offset(-width_*position, 0.0),
